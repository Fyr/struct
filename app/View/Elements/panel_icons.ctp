<div class="main-panel-list">
    <ul>
        ...
        <li><a href="javascript:void(0)"><span class="glyphicons chat chatPanel"></span><div id="chatTotalUnread" class="count"></div></a></li>
        <li><a href="javascript:void(0)"><span class="glyphicons group groupPanel"></span></a></li>
        ...
        <li><a href="javascript:void(0)"><span class="glyphicons ipad ipadPanel"></span></a></li>
...
<div class="service-menu">
    <ul>
        ...
        <li><a href="/client/login/logout/"><span class="glyphicons exit"></span></a></li>
